...
const init = function () {
  ...
  currentScore = 0; // Can't be inside the function cause gonna be reset every time user click roll
  activePlayer = 0;
  playing = true;
...
btnHold.addEventListener('click', function () {
  if (playing) {
    ...
    // 2. Check if score player's is >= 100: End Game!
